...
Revision ID: 4a339021f2c4
Revises:
Create Date: 2026-05-13 23:26:52.604775
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "description", sa.Text(), nullable=True, comment="Camera description"
        ),
        sa.Column(
            "location", sa.String(length=200), nullable=True, comment="Camera location"
        ),
        sa.Column(
            "rtsp_url", sa.String(length=500), nullable=False, comment="Camera RTSP URL"
        ),
        sa.Column(
            "webrtc_url",
